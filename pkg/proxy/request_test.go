...
func TestCustomImageFeatureFlag(t *testing.T) {
	for _, ti := range []struct {
		...
		{
			tag:                     "Nested Image format",
			allowedCustomImages:     true,
			masterImage:             "this/is/a/nested/image:format",
			workerImage:             "this/is/a/nested/image:format",
			expectedMasterImageName: "this/is/a/nested/image",
			expectedMasterImageTag:  "format",
			expectedWorkerImageName: "this/is/a/nested/image",
			expectedWorkerImageTag:  "format",
			expectError:             false,
		},
		{
			tag:                     "Image format with custom repo",
			allowedCustomImages:     true,
			masterImage:             "test.com/some/very/nested/repository/image:v1.7",
			workerImage:             "test.com/some/very/nested/repository/image:v1.7",
			expectedMasterImageName: "test.com/some/very/nested/repository/image",
			expectedMasterImageTag:  "v1.7",
			expectedWorkerImageName: "test.com/some/very/nested/repository/image",
			expectedWorkerImageTag:  "v1.7",
			expectError:             false,
		},
		{
			tag:                     "Image format with custom repo and port",
			allowedCustomImages:     true,
			masterImage:             "test.com:5000/some/very/nested/repository/image:v1.7",
			workerImage:             "test.com:5000/some/very/nested/repository/image:v1.7",
			expectedMasterImageName: "test.com:5000/some/very/nested/repository/image",
			expectedMasterImageTag:  "v1.7",
			expectedWorkerImageName: "test.com:5000/some/very/nested/repository/image",
			expectedWorkerImageTag:  "v1.7",
			expectError:             false,
		},
		{
			tag:                     "Image format without tag",
			allowedCustomImages:     true,
			masterImage:             "test.com:5000/some/very/nested/repository/image",
			workerImage:             "test.com:5000/some/very/nested/repository/image",
			expectedMasterImageName: "test.com:5000/some/very/nested/repository/image",
			expectedMasterImageTag:  "",
			expectedWorkerImageName: "test.com:5000/some/very/nested/repository/image",
			expectedWorkerImageTag:  "",
