...
The following is a set of guidelines for contributing to Kangal and its packages, 
...
This section guides you through submitting a bug report for Kangal. Following these guidelines helps maintainers 
...
* **Describe the exact steps which reproduce the problem** in as many details as possible. For example, start by explaining how you started Kangal, 
...
* **Which version of Kangal are you using?**
* **What's the name and version of the OS you're using**?

### Your First Code Contribution

Unsure where to begin contributing to Kangal? You can start by looking through these `beginner` and `help-wanted` issues:
